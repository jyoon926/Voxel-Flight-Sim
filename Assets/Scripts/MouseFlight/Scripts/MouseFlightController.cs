...
namespace MFlight
{
    ...
    public class MouseFlightController : MonoBehaviour
    {
        ...
        [SerializeField] [Tooltip("Plane object")]
        private GameObject plane;
        [SerializeField] [Tooltip("Missile prefab")]
        private GameObject missile;
        [SerializeField] [Tooltip("Missile spawn point")]
        private Transform missileSpawn;
        [SerializeField] [Tooltip("AimPosition script")]
        private AimPosition aimPosition;
        [SerializeField] [Tooltip("World object")]
        private World world;
        ...
        [SerializeField] [Tooltip("Cooldown for missile shooting")]
